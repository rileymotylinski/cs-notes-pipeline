...
```
1) create a /models/ directory in the project directory
2) place your typst/markdown notes in /lib/test_notes/ (create if doesn't exist)
3) run labeling.py to label data for training
4) run classifier.py to train the model
5) run inference.py to extract concepts from a new file
```
### Labeling.py
